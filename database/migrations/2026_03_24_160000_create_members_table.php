...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('members', function (Blueprint $table) {
            $table->id();
            $table->string('first_name', 50)->nullable()->default(null)->comment('名字');
            $table->string('last_name', 50)->nullable()->default(null)->comment('姓氏');
            ...
            $table->date('birth_date')->nullable()->default(null)->comment('生日');
            $table->text('address')->nullable()->default(null)->comment('住址');
            $table->unsignedTinyInteger('gender')->nullable()->default(null)->comment('性別');
            $table->rememberToken();
